...
const AuthPage = ({ type }) => {
  ...
  const handleSubmit = (e) => {
    ...
    // ✅ SIMULATION: Save name and email to localStorage
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center pt-20 px-6">
      ...
      >
        ...
        <p className="text-center text-gray-500 mb-8">
            {isLogin ? 'Sign in to access your scoop history.' : 'Join us for sweet rewards!'}
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          {!isLogin && (
            <div className="relative">
              ...
              <input 
                ...
                required 
                className="w-full p-4 pl-12 rounded-xl border border-gray-200 focus:ring-2 focus:ring-pink-200 focus:border-pink-400 transition" 
              />
            </div>
          )}
          <div className="relative">
          ...
          <Motion.button 
            ...
            whileTap={{ scale: 0.98 }}
            type="submit" 
            className="w-full py-4 bg-gray-900 text-white rounded-xl font-bold text-lg hover:bg-pink-600 transition-colors shadow-md"
          >
