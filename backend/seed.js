...
const seedFlavors = [
  { name: "Chocolate Lava", category: "Chocolate", price: 4.50, image: "https://images.unsplash.com/photo-1563805042-7684c019e1cb?auto=format&fit=crop&q=80&w=400", description: "Rich, decadent chocolate ice cream with a molten chocolate core. A chocolate lover's dream.", ingredients: ["Cocoa","Milk","Dark Chocolate","Vanilla Bean"], slug: "chocolate-lava", isFeatured: true },
  { name: "Mango Magic", category: "Fruit", price: 4.00, image: "https://images.unsplash.com/photo-1505394033343-e3015a1a7051?auto=format&fit=crop&q=80&w=400", description: "Alphonso mango pulp mixed into a creamy base. Pure sunshine.", ingredients: ["Mango Pulp","Cream","Sugar"], slug: "mango-magic", isFeatured: true },
  { name: "Pistachio Dream", category: "Special", price: 5.00, image: "https://images.unsplash.com/photo-1501443762994-82bd5dace89a?auto=format&fit=crop&q=80&w=400", description: "Rich pistachio ice cream with crunchy roasted pistachios.", ingredients: ["Pistachios","Cream","Sugar","Milk"], slug: "pistachio-dream", isFeatured: true },
...
async function seed() {
  ...
  await Flavor.insertMany(seedFlavors);
  console.log(`✅ Seeded ${seedFlavors.length} flavors`);
